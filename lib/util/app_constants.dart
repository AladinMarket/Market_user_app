...
class AppConstants {
  ...
  static const String webHostedUrl = 'https://portail.aladinmarket-bf.com';
  // static const String webHostedUrl = 'http://localhost/admin';
  ...
  /// Delivery Tips
  static List<String> tips = ['0' ,'10', '25', '50', '100', 'plus'];
